...
function FontSize(editor) {
    ...
    this.droplist = new DropList(this, {
        ...
        $title: $('<p>字号</p>'),
        type: 'list', // droplist 以列表形式展示
        list: [{ $elem: $('<span style="font-size: x-small;">12</span>'), value: '1' }, { $elem: $('<span style="font-size: small;">14</span>'), value: '2' }, { $elem: $('<span>18</span>'), value: '3' }, { $elem: $('<span style="font-size: large;">22</span>'), value: '4' }, { $elem: $('<span style="font-size: x-large;">26</span>'), value: '5' }, { $elem: $('<span style="font-size: xx-large;">32</span>'), value: '6' }],
        onClick: function onClick(value) {
...
function Link(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="网页链接"><i class="w-e-icon-link"></i></div>');
    this.type = 'panel';
...
function Italic(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="斜体">\n            <i class="w-e-icon-italic"></i>\n        </div>');
    this.type = 'click';
...
function Undo(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="撤回">\n            <i class="w-e-icon-undo"></i>\n        </div>');
    this.type = 'click';
...
function Quote(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="引用">\n            <i class="w-e-icon-quotes-left"></i>\n        </div>');
    this.type = 'click';
...
function Code(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="代码">\n            <i class="w-e-icon-terminal"></i>\n        </div>');
    this.type = 'panel';
...
function Table(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="表格"><i class="w-e-icon-table2"></i></div>');
    this.type = 'panel';
...
function Video(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu" title="视频"><i class="w-e-icon-play"></i></div>');
    this.type = 'panel';
...
function Image(editor) {
    ...
    this.$elem = $('<div class="w-e-menu" id="' + imgMenuId + '" title="图片"><i class="w-e-icon-image"></i></div>');
...
UploadImg.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        // editor.cmd.do('insertHTML', '<video src="' + link + '" style="width:100%" controls></video>');
